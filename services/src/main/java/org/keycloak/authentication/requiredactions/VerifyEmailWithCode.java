 ...
 * @version $Revision: 1 $
 */
public class VerifyEmailWithCode implements RequiredActionProvider, RequiredActionFactory, ServerInfoAwareProviderFactory {
    ...
    private static final Logger logger = Logger.getLogger(VerifyEmailWithCode.class);
